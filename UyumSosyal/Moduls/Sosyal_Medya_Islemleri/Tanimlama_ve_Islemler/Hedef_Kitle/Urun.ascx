...
<script runat="server">
    protected void StoreUrunSol_RefershData(object sender, StoreReadDataEventArgs e)
    {
        ...
        try
        {
            ...
            store.DataSource = UyumSosyal.Moduls.Sosyal_Medya_Islemleri.Shared.UrunSariAlanListesi.GetFilterL(0, 1000);
            store.DataBind();
        }
        catch(Exception ex)
        {
            Helper.Error("HedefKitleUrunListe'de web service hatası : " + ex.Message);
        }
    }

    protected void StoreUrunSag_RefershData(object sender, StoreReadDataEventArgs e)
    {
        X.MessageBox.Show( new MessageBoxConfig() {
            Message = "Islem yapilirken lutfen bekleyiniz.",
            ProgressText = "Bekleyiniz...",
        ...
        {
            var store = (Store)sender;
            store.DataSource = UyumSosyal.Moduls.Sosyal_Medya_Islemleri.Shared.UrunSariAlanListesi.GetFilterR(0, 1000);
            store.DataBind();
        }
        catch(Exception ex)
        {
...
<ext:Panel runat="server" Width="700" Height="330">
    ...
    <Items>
        <ext:GridPanel
            ...
            MarginSpec="0 2 0 0">
            <Store>
                <ext:Store ID="StoreUrunL" OnReadData="StoreUrunSol_RefershData" runat="server">
                    <Listeners>
            ...
            <ColumnModel>
                <Columns>
                    <ext:Column runat="server" Text="Ürün" Width="160" DataIndex="desc" Flex="1" />
                </Columns>
            </ColumnModel>
            <View>
        ...
        <ext:GridPanel
            ...
            MarginSpec="0 0 0 3">
            <Store>
                <ext:Store ID="StoreUrunR" OnReadData="StoreUrunSag_RefershData" runat="server">
                    <Listeners>
                        <Load Handler="Ext.MessageBox.hide();" Delay="1000"/>
                    </Listeners>
                    <Model>
