...
<script runat="server">
    protected void StoreSektorSol_RefershData(object sender, StoreReadDataEventArgs e)
    {
        ...
        try
        {
            ...
            store.DataSource = UyumSosyal.Moduls.Sosyal_Medya_Islemleri.Shared.SektorSariAlanListesi.GetFilterL(0, 1000);
            store.DataBind();
        }
        catch(Exception ex)
        {
            Helper.Error("HedefKitleSektorListe'de web service hatası : " + ex.Message);
        }
    }

    protected void StoreSektorSag_RefershData(object sender, StoreReadDataEventArgs e)
    {
        X.MessageBox.Show( new MessageBoxConfig() {
            Message = "Islem yapilirken lutfen bekleyiniz.",
            ProgressText = "Bekleyiniz...",
        ...
        {
            var store = (Store)sender;
            store.DataSource = UyumSosyal.Moduls.Sosyal_Medya_Islemleri.Shared.SektorSariAlanListesi.GetFilterR(0, 1000);
            store.DataBind();
        }
        catch(Exception ex)
        {
...
<ext:Panel runat="server" Width="700" Height="330">
    ...
    <Items>
        <ext:GridPanel
            ...
            MarginSpec="0 2 0 0">
            <Store>
                <ext:Store ID="StoreSektorL" OnReadData="StoreSektorSol_RefershData" runat="server">
                    <Listeners>
            ...
            <ColumnModel>
                <Columns>
                    <ext:Column runat="server" Text="Sektör" Width="160" DataIndex="desc" Flex="1" />
                </Columns>
            </ColumnModel>
            <View>
        ...
        <ext:GridPanel
            ...
            MarginSpec="0 0 0 3">
            <Store>
                <ext:Store ID="StoreSektorR" OnReadData="StoreSektorSag_RefershData" runat="server">
                    <Listeners>
                        <Load Handler="Ext.MessageBox.hide();" Delay="1000"/>
                    </Listeners>
                    <Model>
