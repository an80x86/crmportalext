...
<script runat="server">
    ...
    {
        if (TextFieldFormId.Text.Trim().Length < 1)
        {
            X.Msg.Alert("Dikkat", "Form Id boş bırakılamaz!").Show();
            return;
        }

        if (TextFieldFormAd.Text.Trim().Length < 1)
        {
            X.Msg.Alert("Dikkat", "From Ad boş bırakılamaz!").Show();
            return;
        }
        ...
        try
        {
            var err = UyumSosyal.Moduls.Sosyal_Medya_Islemleri.Shared.SosyalMedyaForm.Save(
                gizli.Value, // ekle ise boş düzelt ise dolu gelir
                TextFieldFormId.Text.Trim(),
                TextFieldFormAd.Text.Trim(),
                ComboBoxSosyal.SelectedItem.Value,
                CheckboxPasif.Checked);
            if (err != "ok")
            {
        ...
        {
             Helper.Error("SosyalMedyaFormKaydet'de web service hatası : " + ex.Message);
        }

        // tazele
        Store1.Reload();
        gizli.Value = "";
        TextFieldFormId.Text = "";
        TextFieldFormAd.Text = "";
    ...
    public void Sil(int kkod)
    {
        try
        {
            var don = UyumSosyal.Moduls.Sosyal_Medya_Islemleri.Shared.SosyalMedyaForm.Remove(kkod);
            X.MessageBox.Hide();
            if (don != "ok")
            {
            ...
            else
            {
                ...
                Store1.Reload();
                gizli.Value = "";
                lbUser.Text = "Seçilen Form : Yok!";
            }
        }
        catch(Exception ex)
        {
             Helper.Error("SosyalMedyaFormSil'de web service hatası : " + ex.Message);
        }
        finally
        {
            X.MessageBox.Hide();
...
<body>
    <form id="Form1" runat="server">
        ...
        <asp:ObjectDataSource 
            ...
            TypeName="UyumSosyal.Moduls.Sosyal_Medya_Islemleri.Shared.SosyalMedyaForm">
            <SelectParameters>
        ...
        <ext:Window ID="PickWindowFormAdd" runat="server" Width="300" Height="310" AutoHeight="true" Title="Ekle"
            ...
            <Items>
                ...
                <ext:TextField ID="TextFieldFormId" runat="server" ReadOnly="false" InputType="Text"
                    FieldLabel="Form Id" LabelWidth="50" Width="120" AllowBlank="false" BlankText="Form Id boş geçilemez!" MaxLengthText="50"
                ...
                <ext:TextField ID="TextFieldFormAd" runat="server" ReadOnly="false" InputType="Text"
                               FieldLabel="Form Ad" LabelWidth="50" Width="120" AllowBlank="false" MaxLengthText="50"
                               Text="" EnableKeyEvents="true">
                    <Listeners>
                ...
                <ext:ComboBox ID="ComboBoxSosyal"
                              ...
                              QueryMode="Local">
                    <Items>
                        <ext:ListItem Text="FaceBook" />
                        <ext:ListItem Text="Instagram" />
                    </Items>
                </ext:ComboBox>

                <ext:Checkbox ID="CheckboxPasif" runat="server" FieldLabel="Pasif" Name="Pasif">
                </ext:Checkbox>
            </Items>
            <Buttons>
                            ...
                            <Items>
                                ...
                                <ext:Button ID="BntSave" runat="server" Enabled="true" Text="Ekle" Icon="ApplicationAdd">
                                    <Listeners>
                                        <Click Handler="
                                            ...
                                            #{TextFieldFormId}.setValue('');
                                            #{TextFieldFormAd}.setValue('');
                                            #{ComboBoxSosyal}.setValue('');
                                            #{CheckboxPasif}.setValue(false);                                        
                                ...
                                <ext:Button ID="BtnEdit" runat="server" Enabled="true" Text="Düzelt" Icon="ApplicationEdit">
                                    <Listeners>
                                        ...
                                        #{TextFieldFormId}.setValue(v[0].data.form_id);
                                        #{TextFieldFormAd}.setValue(v[0].data.form_ad);
                                        #{ComboBoxSosyal}.setValue(v[0].data.form_tip);
                                        #{CheckboxPasif}.setValue(v[0].data.pasif);                                        
                                        #{PickWindowFormAdd}.show();" />
                                    </Listeners>   
                                </ext:Button>
                                ...
                                <ext:Button ID="BtnRemove" runat="server" Enabled="true" Text="Sil" Icon="ApplicationDelete">
                                    <Listeners>
                                        <Click Handler="
                                                        var v= #{GridPanel1}.getSelectionModel().getSelection();
                                                        if (v.length==0) return;
                                                        Ext.MessageBox.confirm('Dikkat', 'Silmek istiyor musunuz?\n('+v[0].data.form_id + ' ' + v[0].data.form_ad + ')', showResult );" Delay="1"/>
                                    </Listeners>
                                </ext:Button>                                

                                <ext:ToolbarSeparator/>

                                <ext:Label ID="lbUser" runat="server" Text="Seçilen Form : Yok!"></ext:Label>                                
                            </Items>
                        </ext:Toolbar>
                        ...
                        <ext:GridPanel ID="GridPanel1" 
                            ...
                            <Store>
                                ...
                                <ext:Store 
                                    ...
                                    <Sorters>
                                        <ext:DataSorter Property="form_id" Direction="ASC" />
                                    </Sorters>
                                </ext:Store>
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    <ext:Column ID="Id" runat="server" Text="Form Id" DataIndex="form_id" Sortable="true" Flex="1" />
                                    <ext:Column ID="Column3" runat="server" Text="Form Ad" DataIndex="form_ad" Width="230" />
                                    <ext:Column ID="Column4" runat="server" Text="Tip" DataIndex="form_tip" Width="130" />
                                    <ext:CheckColumn ID="CheckColumn1" runat="server" DataIndex="pasif" Text="Pasif"  Width="130"/>
                                </Columns>
                            </ColumnModel>
                            <View>
                            ...
                            <Listeners>
                                <Select Handler="
                                    ...
                                    if (v.length>0) { 
                                        ...
                                        #{lbUser}.setText('Seçilen Form : ' + v[0].data.form_id + ' ' + v[0].data.form_ad);
                                    } else {
                                        #{gizli}.setValue(''); 
                                        #{lbUser}.setText('Seçilen Form : Yok!');
                                } "/>
