...
var makeTab = function (id, url, title) {
        ...
        listeners: {
            show: {
                fn: function () {
                    ...
                    this.body.mask("Yükleniyor...", "x-mask-loading");
                    Ext.Ajax.request({
                        url: "Loader.ashx",
                        ...
                        failure: function (response) {
                            this.body.unmask();
                            Ext.Msg.alert("Failure", "The error during modul loading:\n" + response.responseText);
                        },
                        params: {
                            id: id,
                            url: url,
    ...
    tab = App.ExampleTabs.add(new Ext.Panel({
        ...
        */
        ...
        loader: {
            scripts: true,
            url: hostName + "/Moduls" + url,
            renderer: "frame",
            listeners: {
                beforeload: function () {
                    this.target.body.mask('Yükleniyor...');
                },
                load: {
                    fn: function (loader) {
...
var getToken = function (url) {
    var host = window.location.protocol + "//" + window.location.host + "/Moduls";
...
var updateComments = function (updateCount, url) {
    winComments.body.mask("Yükleniyor...", "x-mask-loading");
